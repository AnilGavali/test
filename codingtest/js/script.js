let chargesTicket = [25000, 20000, 6000, 2000, 3000, 1000];
...
iplForm.addEventListener("submit", function (e) {
  ...
  } else if (specName.value != "" && email.value != "" && confirmEmail.value != "" && floor.value != "" && stand.value != "") alert("All data entered correctly");
});
